...
Source0  : http://netfilter.org/projects/libnftnl/files/libnftnl-1.1.9.tar.bz2
...
%prep
%setup -q -n libnftnl-1.1.9
cd %{_builddir}/libnftnl-1.1.9
pushd ..
cp -a libnftnl-1.1.9 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610747292
...
cp %{_builddir}/libnftnl-1.1.9/COPYING %{buildroot}/usr/share/package-licenses/libnftnl/d6458d52bfead6f1399b865f1aeea0caa639ef6c
pushd ../build32/
%make_install32
...
/usr/lib64/libnftnl.so.11.5.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnftnl.so.11
/usr/lib32/libnftnl.so.11.5.0
