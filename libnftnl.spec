...
Source0  : https://netfilter.org/projects/libnftnl/files/libnftnl-1.2.3.tar.bz2
...
%prep
%setup -q -n libnftnl-1.2.3
cd %{_builddir}/libnftnl-1.2.3
pushd ..
cp -a libnftnl-1.2.3 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660143326
