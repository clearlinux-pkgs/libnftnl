...
Version  : 1.2.2
Release  : 25
URL      : https://netfilter.org/projects/libnftnl/files/libnftnl-1.2.2.tar.bz2
Source0  : https://netfilter.org/projects/libnftnl/files/libnftnl-1.2.2.tar.bz2
...
%prep
%setup -q -n libnftnl-1.2.2
cd %{_builddir}/libnftnl-1.2.2
pushd ..
cp -a libnftnl-1.2.2 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654698571
...
cp %{_builddir}/libnftnl-1.2.2/COPYING %{buildroot}/usr/share/package-licenses/libnftnl/d6458d52bfead6f1399b865f1aeea0caa639ef6c
pushd ../build32/
%make_install32
