...
Version  : 1.0.7
Release  : 8
URL      : http://netfilter.org/projects/libnftnl/files/libnftnl-1.0.7.tar.bz2
Source0  : http://netfilter.org/projects/libnftnl/files/libnftnl-1.0.7.tar.bz2
Source99 : http://netfilter.org/projects/libnftnl/files/libnftnl-1.0.7.tar.bz2.sig
...
%prep
%setup -q -n libnftnl-1.0.7
pushd ..
cp -a libnftnl-1.0.7 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1490322837
...
/usr/lib64/libnftnl.so.4.2.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libnftnl.so.4
/usr/lib32/libnftnl.so.4.2.0
