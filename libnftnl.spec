...
Version  : 1.2.8
Release  : 35
URL      : https://netfilter.org/projects/libnftnl/files/libnftnl-1.2.8.tar.xz
Source0  : https://netfilter.org/projects/libnftnl/files/libnftnl-1.2.8.tar.xz
Source1  : https://netfilter.org/projects/libnftnl/files/libnftnl-1.2.8.tar.xz.sig
...
%setup -q -n libnftnl-1.2.8
cd %{_builddir}/libnftnl-1.2.8
pushd ..
cp -a libnftnl-1.2.8 build32
popd
pushd ..
cp -a libnftnl-1.2.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727967901
