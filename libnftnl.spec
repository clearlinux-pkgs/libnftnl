...
Source0  : https://netfilter.org/projects/libnftnl/files/libnftnl-1.2.6.tar.xz
Source1  : https://netfilter.org/projects/libnftnl/files/libnftnl-1.2.6.tar.xz.sig
...
%prep
%setup -q -n libnftnl-1.2.6
cd %{_builddir}/libnftnl-1.2.6
pushd ..
cp -a libnftnl-1.2.6 build32
popd
pushd ..
cp -a libnftnl-1.2.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689173934
