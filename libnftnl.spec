...
Source0  : https://netfilter.org/projects/libnftnl/files/libnftnl-1.2.1.tar.bz2
...
%prep
%setup -q -n libnftnl-1.2.1
cd %{_builddir}/libnftnl-1.2.1
pushd ..
cp -a libnftnl-1.2.1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637252496
...
cp %{_builddir}/libnftnl-1.2.1/COPYING %{buildroot}/usr/share/package-licenses/libnftnl/d6458d52bfead6f1399b865f1aeea0caa639ef6c
pushd ../build32/
%make_install32
