...
Source0  : https://netfilter.org/projects/libnftnl/files/libnftnl-1.2.5.tar.xz
Source1  : https://netfilter.org/projects/libnftnl/files/libnftnl-1.2.5.tar.xz.sig
...
%prep
%setup -q -n libnftnl-1.2.5
cd %{_builddir}/libnftnl-1.2.5
pushd ..
cp -a libnftnl-1.2.5 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678463034
